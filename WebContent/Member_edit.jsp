...
<div class ="container">
	<form name = "form" action ="Member_edit_ok.jsp" method = "post" onsubmit="return check_ok();">
	...
	<div class = "form-input">
		...
		<div><% 
			Object lob = session.getAttribute("email");			
			String get = (String)lob;
				out.println(lob );%></div>
...
<script>
	function check_ok(){
		...
		if(confirmcheck==0) {
			...
			$.post("Member_edit_ok.jsp", formdata)
